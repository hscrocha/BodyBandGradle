...
import com.BodyBand.model.bbRepetition;
...
public class userNewRepControl1B implements Initializable {
        ...
        Runnable background = new Runnable() {
            ...
            public void run() {
                try (ResultSet tempExercise =
                             bbDatabase.getInstance().getExerciseSetWithKey(userNewSetControl1A.getCurrentExerciseID())) {
                ...
                Platform.runLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        currentDateTime = userNewSetControl1A.getCurrentDateTime();
...
class GetAllRepetitionsForSet extends Task {
    ...
    public ObservableList<bbRepetition> call() {
        ...
        return FXCollections.observableArrayList(bbDatabase.getInstance().getRepListFromRepString(userNewSetControl1A.getRepString()));
    }
}