package com.BodyBand;

import com.BodyBand.controller.*;
...
public class sceneNavigation {
    ...
    public void showAdminExPage() {
        try {
            Parent exercisePage = FXMLLoader.load(getClass().getResource("adminExercise.fxml"));
    ...
    public void showAdminSetPage() {
        try {
            Parent setPage = FXMLLoader.load(getClass().getResource("adminSet.fxml"));
    ...
    public void showAdminRepPage() {
        try {
            Parent repPage = FXMLLoader.load(getClass().getResource("adminRepetition.fxml"));
    ...
    public void showAdminNewExPage() {
        try {
            Parent addExercise = FXMLLoader.load(getClass().getResource("adminNewEx.fxml"));
    ...
    public void showAdminNewRepPage() {
        try {
            Parent addRep = FXMLLoader.load(getClass().getResource("adminNewRep.fxml"));
    ...
    public void showAdminNewSetPage() {
        try {
            Parent addSet = FXMLLoader.load(getClass().getResource("adminNewSet.fxml"));
    ...
    public void showUserNewSet1A(){
        try {
            FXMLLoader exerciseListLoader = new FXMLLoader(getClass().getResource("userNewSet1A.fxml"));
    ...
    public void showUserNewRep1B() {
        try {
            FXMLLoader exerciseSetLoader = new FXMLLoader(getClass().getResource("userNewRep1B.fxml"));
    ...
    public void showExerciseHistory(){
        try{
            FXMLLoader exerciseHistoryLoader = new FXMLLoader(getClass().getResource("userExerciseHistory.fxml"));
    ...
    public void showUserPrevDate2A(){
        try {
            FXMLLoader dateListLoader = new FXMLLoader(getClass().getResource("userPrevDate2A.fxml"));
    ...
    public void showUserPrevEx2B() {
        try {
            FXMLLoader exerciseSetLoader = new FXMLLoader(getClass().getResource("userPrevEx2B.fxml"));
            Parent newSet = exerciseSetLoader.load();
    ...
    public void showUserPrevRep2C() {
        try {
            FXMLLoader exerciseSetLoader = new FXMLLoader(getClass().getResource("userPrevRep2C.fxml"));
            Parent newSet = exerciseSetLoader.load();
